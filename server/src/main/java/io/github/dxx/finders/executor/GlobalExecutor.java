...
public class GlobalExecutor {
    ...
    private static final ExecutorService BACKGROUND_EXECUTOR = ExecutorFactory
            .newFixedExecutorService(DEFAULT_THREAD_COUNT, new NamedThreadFactory("finders-background-executor"));

...
public class HelloHandler {
    ...
    @RequestMapping(path = Paths.HELLO, method = RequestMethod.GET)
    ...
    @RequestMapping(path = Paths.HELLO1, method = RequestMethod.GET)
    public void hello1(RoutingContext context) {
        context.response().end("Hello1!");
    }

    @RequestMapping(path = Paths.DATA, method = RequestMethod.POST)
